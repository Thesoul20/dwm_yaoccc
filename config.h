...
static const char *tags[] = {
    "\ue745", // tag:0 key:1 desc: 网页浏览 (Material Design Icons: web) 
    "\uf121", // tag:1 key:2 desc: Code 编程 (Font Awesome: code) 
    "\uf02d", // tag:2 key:3 desc: 浏览文件 & Obsidian 笔记 (Font Awesome: book 或 \uf537 clipboard-list) 
    "\uf04b", // tag:3 key:9 desc: 3Dslicer 医学图像 & 脑图写作 (Font Awesome: play-circle, 保持原有，如果需要更医学的可以找 "\uf7fd" user-md-alt) 
    "\ue795", // tag:4 key:c desc: 其它桌面 (Devicons: atom, 或其他通用图标) 
    "\uf0eb", // tag:5 key:m desc: 其它桌面 (Font Awesome: lightbulb) 
    "\uf2c6", // tag:6 key:m desc: 其它桌面 (Font Awesome: telegram-plane, 原本的 \uf120 是 code, \uf2c6 更像 telegram) 
    "\uf0e7", // tag:7 key:0 desc: 其它桌面 (Font Awesome: bolt) 
    "\uf518"  // tag:8 key:w desc: 其它桌面 (Font Awesome: pizza-slice) 
    "\uf013"  // tag:9 key:e desc: 新增的第10个桌面 (Font Awesome: cog / gear) 
};
...
static const Rule rules[] = {
    ...
    { "copyq",               NULL,                 NULL,             TAGMASK,      1,          1,          1,        -1,      0}, // copyq相关的子窗口，去掉边框
...
static Key keys[] = {
    ...
    { Mod1Mask,             XK_Tab,          alttab,           {0} },                     /* alt tab            |  现代Alt+Tab窗口切换 */
    ...
    { MODKEY,              XK_s,      togglescratch, SHCMD("kitty -T scratchpad --class floatingTerminal") },                      /* super s          | 打开scratch终端        */
    { MODKEY,              XK_Return, spawn, SHCMD("kitty") },                                                     /* super enter      | 打开kitty终端             */
    // { MODKEY,              XK_minus,  spawn, SHCMD("kitty -c FG") },                                               /* super +          | 打开全局st终端         */
    { MODKEY,              XK_minus,  spawn, SHCMD("kitty --class floatingTerminal") },                                            /* super -      | 打开浮动kitty终端         */
    { MODKEY,              XK_F1,     spawn, SHCMD("killall pcmanfm || pcmanfm") },                             /* super F1         | 打开/关闭pcmanfm       */
    { MODKEY,              XK_space,  spawn, SHCMD("rofi -show run") },						/* super space      | rofi: 执行run          */
    ...
    { MODKEY,              XK_v,      spawn, SHCMD("copyq toggle") },                                           /* super v          | copyq main              */
    { MODKEY|ShiftMask,    XK_r,      spawn, SHCMD("~/.config/xremap/aigo.sh") },                               /* super shift r    | keyboardremapping              */
